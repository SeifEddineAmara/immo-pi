...
public class AdvertisingController {
    ...
    @PostMapping("/get-All-Actual-Advertising")
    public ResponseEntity<?> getAllActualAdvertising(
            @RequestBody() AdvInput data,
            HttpServletRequest request
    ) {

        LocalDate startDate = LocalDate.parse(data.getStart());
        LocalDate endDate = LocalDate.parse(data.getEnd());
